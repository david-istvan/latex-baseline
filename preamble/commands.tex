...
\newcommand{\preprintlabel}[2]{
    \placetextbox{0.5}{0.99}{\colorbox{gray!3}{\textcolor{WildStrawberry}{{{#2}}}}}%

    \placetextbox{0.5}{0.97}{\colorbox{gray!3}{\textcolor{WildStrawberry}{Author pre-print. The final publication is available at: \url{https://doi.org/#1}.}}}%
    
    \placetextbox{0.5}{0.05}{\colorbox{gray!3}{\textcolor{WildStrawberry}{Author pre-print. The final publication is available at: \url{https://doi.org/#1}.}}}%
}